...
//
// API reference: https://developers.khulnasoft.com/access/configuring-identity-providers/
...
// account or zone.
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-identity-providers-list-access-identity-providers
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-identity-providers-list-access-identity-providers
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-identity-providers-get-an-access-identity-provider
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-identity-providers-get-an-access-identity-provider
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-identity-providers-add-an-access-identity-provider
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-identity-providers-add-an-access-identity-provider
...
// Provider.
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-identity-providers-update-an-access-identity-provider
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-identity-providers-update-an-access-identity-provider
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-identity-providers-delete-an-access-identity-provider
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-identity-providers-delete-an-access-identity-provider
...
// Provider.
// AzureAD only
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-identity-providers-refresh-an-access-identity-provider-auth-contexts
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-identity-providers-update-an-access-identity-provider
