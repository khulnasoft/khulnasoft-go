...
type RequestError struct {
	khulnasoftError *Error
}

func (e RequestError) Error() string {
	return e.khulnasoftError.Error()
}

func (e RequestError) Errors() []ResponseInfo {
	return e.khulnasoftError.Errors
}

func (e RequestError) ErrorCodes() []int {
	return e.khulnasoftError.ErrorCodes
}

func (e RequestError) ErrorMessages() []string {
	return e.khulnasoftError.ErrorMessages
}

func (e RequestError) InternalErrorCodeIs(code int) bool {
	return e.khulnasoftError.InternalErrorCodeIs(code)
}

func (e RequestError) Messages() []ResponseInfo {
	return e.khulnasoftError.Messages
}

func (e RequestError) RayID() string {
	return e.khulnasoftError.RayID
}

func (e RequestError) Type() ErrorType {
	return e.khulnasoftError.Type
}

func (e RequestError) Unwrap() error {
	return e.khulnasoftError
}
