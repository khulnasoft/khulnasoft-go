	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprintf(w, `{
			...
			"result": {
				...
				"aud": "737646a56ab1df6ec9bddc7e5ca84eaf3b0768850f3ffb5d74f1534911fe3893",
				"name": "Admin Saas App",
				"domain": "example.khulnasoftaccess.com/cdn-cgi/access/sso/saml/737646a56ab1df6ec9bddc7e5ca84eaf3b0768850f3ffb5d74f1534911fe3893",
				"type": "saas",
				"session_duration": "24h",
				"allowed_idps": [],
				"auto_redirect_to_identity": false,
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
		...
		fmt.Fprintf(w, `{
			...
			"result": {
				...
				"domain": "example.khulnasoftaccess.com/cdn-cgi/access/sso/oidc/737646a56ab1df6ec9bddc7e5ca84eaf3b0768850f3ffb5d74f1534911fe3893",
				"type": "saas",
				"session_duration": "24h",
				"allowed_idps": [],
				"auto_redirect_to_identity": false,
