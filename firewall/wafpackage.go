...
// [previous version of WAF managed rules](https://developers.khulnasoft.com/support/firewall/managed-rules-web-application-firewall-waf/understanding-waf-managed-rules-web-application-firewall/).
