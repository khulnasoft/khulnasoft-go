...
func TestWAFPackageListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Firewall.WAF.Packages.List(
		...
		firewall.WAFPackageListParams{
			Direction: khulnasoft.F(firewall.WAFPackageListParamsDirectionAsc),
			Match:     khulnasoft.F(firewall.WAFPackageListParamsMatchAny),
			Name:      khulnasoft.F("USER"),
			Order:     khulnasoft.F(firewall.WAFPackageListParamsOrderName),
