...
func TestUARuleNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Firewall.UARules.New(
		...
		firewall.UARuleNewParams{
			Configuration: khulnasoft.F[firewall.UARuleNewParamsConfigurationUnion](firewall.AccessRuleIPConfigurationParam{
				Target: khulnasoft.F(firewall.AccessRuleIPConfigurationTargetIP),
				Value:  khulnasoft.F("198.51.100.4"),
			}),
			Mode: khulnasoft.F(firewall.UARuleNewParamsModeBlock),
		},
	)
	if err != nil {
...
func TestUARuleUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Firewall.UARules.Update(
		...
		firewall.UARuleUpdateParams{
			Configuration: khulnasoft.F[firewall.UARuleUpdateParamsConfigurationUnion](firewall.AccessRuleIPConfigurationParam{
				Target: khulnasoft.F(firewall.AccessRuleIPConfigurationTargetIP),
				Value:  khulnasoft.F("198.51.100.4"),
			}),
			Mode: khulnasoft.F(firewall.UARuleUpdateParamsModeBlock),
		},
	)
	if err != nil {
		var apierr *khulnasoft.Error
...
func TestUARuleListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Firewall.UARules.List(
		...
		firewall.UARuleListParams{
			Description:       khulnasoft.F("abusive"),
			DescriptionSearch: khulnasoft.F("abusive"),
			Page:              khulnasoft.F(1.000000),
			PerPage:           khulnasoft.F(1.000000),
			UASearch:          khulnasoft.F("Safari"),
		},
	)
	if err != nil {
		var apierr *khulnasoft.Error
