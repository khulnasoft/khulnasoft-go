...
var mockPageShieldSettings = PageShieldSettings{
	PageShield: PageShield{
		...
		UseKhulnasoftReportingEndpoint: BoolPtr(true),
...
func TestUpdatePageShieldSettings(t *testing.T) {
	...
	newSettings := UpdatePageShieldSettingsParams{
		...
		UseKhulnasoftReportingEndpoint: BoolPtr(false),
	...
	assert.Equal(t, false, *result.PageShield.UseKhulnasoftReportingEndpoint)
