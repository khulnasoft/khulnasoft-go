...
func TestGetRuleset_WAF(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
      ...
      "result": {
        ...
        "name": "Khulnasoft Normalization Ruleset",
        "description": "Created by the Khulnasoft security team, this ruleset provides normalization on the URL path",
        "kind": "managed",
        "version": "1",
        "rules": [
          {
...
func TestGetRuleset_SetCacheSettings(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
      ...
      "result": {
        "id": "70339d97bdb34195bbf054b1ebe81f76",
        "name": "Khulnasoft Cache Rules Ruleset",
...
func TestGetRuleset_SetConfig(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
      ...
      "result": {
        "id": "70339d97bdb34195bbf054b1ebe81f76",
        "name": "Khulnasoft Config Rules Ruleset",
...
func TestGetRuleset_RedirectFromValue(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
      ...
      "result": {
        "id": "70339d97bdb34195bbf054b1ebe81f76",
        "name": "Khulnasoft Redirect Rules Ruleset",
...
func TestGetRuleset_CompressResponse(t *testing.T) {
	...
	handler := func(w http.ResponseWriter, r *http.Request) {
      ...
      "result": {
        "id": "70339d97bdb34195bbf054b1ebe81f76",
        "name": "Khulnasoft compress response ruleset",
