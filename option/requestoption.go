...
// RequestOption is an option for the requests made by the khulnasoft API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/khulnasoft/khulnasoft-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.khulnasoft.com/client/v4/")
}
