...
// [Update DNS Settings](https://developers.khulnasoft.com/api/operations/dns-settings-for-a-zone-update-dns-settings).
...
//
// Deprecated in favor of
// [Show DNS Settings](https://developers.khulnasoft.com/api/operations/dns-settings-for-a-zone-list-dns-settings).
