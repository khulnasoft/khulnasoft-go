...
//
// API reference: https://developers.khulnasoft.com/api/operations/account-roles-list-roles
...
//
// API reference: https://developers.khulnasoft.com/api/operations/account-roles-role-details
