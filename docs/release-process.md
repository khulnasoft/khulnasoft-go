...
We aim to release on a fortnightly cadence, alternating weeks with the [terraform-provider-khulnasoft](https://github.com/khulnasoft/terraform-provider-khulnasoft).
...
- Review the latest [releases](https://github.com/khulnasoft/khulnasoft-go/releases); or
- Review the [current milestones](https://github.com/khulnasoft/khulnasoft-go/milestones).
...
- Ensure CI is passing for [`master` branch](https://github.com/khulnasoft/khulnasoft-go/actions?query=branch%3Amaster).
- Remove "(Unreleased)" portion from the header for the version you are intending
  ...
  * dependency: Update foo to v0.0.2 ([#1184](https://github.com/khulnasoft/khulnasoft-go/issues/123))
  ```
