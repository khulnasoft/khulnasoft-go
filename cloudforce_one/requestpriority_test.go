	...
	_, err := client.CloudforceOne.Requests.Priority.New(
		...
		cloudforce_one.RequestPriorityNewParams{
			PriorityEdit: cloudforce_one.PriorityEditParam{
				Labels:      khulnasoft.F([]cloudforce_one.LabelParam{"DoS", "CVE"}),
				Priority:    khulnasoft.F(int64(1)),
				Requirement: khulnasoft.F("DoS attacks carried out by CVEs"),
				Tlp:         khulnasoft.F(cloudforce_one.PriorityEditTlpClear),
			},
		},
	)
	if err != nil {
