...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-groups-list-access-groups
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-groups-list-access-groups
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-groups-get-an-access-group
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-groups-get-an-access-group
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-groups-create-an-access-group
// Zone API Reference:https://developers.khulnasoft.com/api/operations/zone-level-access-groups-create-an-access-group
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-groups-update-an-access-group
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-groups-update-an-access-group
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-groups-delete-an-access-group
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-groups-delete-an-access-group
