...
//
// API reference: https://api.khulnasoft.com/#device-client-certificates
...
// match the policy.
//
// API reference: https://api.khulnasoft.com/#devices-create-device-settings-policy
...
//
// API reference: https://api.khulnasoft.com/#devices-update-default-device-settings-policy
...
//
// API reference: https://api.khulnasoft.com/#devices-update-device-settings-policy
...
//
// API reference: https://api.khulnasoft.com/#devices-delete-device-settings-policy
...
//
// API reference: https://api.khulnasoft.com/#devices-get-default-device-settings-policy
...
//
// API reference: https://api.khulnasoft.com/#devices-get-device-settings-policy-by-id
...
//
// API reference: https://api.khulnasoft.com/#devices-list-device-settings-policies
