...
func TestAnalyticsEventBytimeGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Spectrum.Analytics.Events.Bytimes.Get(context.TODO(), spectrum.AnalyticsEventBytimeGetParams{
		...
		TimeDelta:  khulnasoft.F(spectrum.AnalyticsEventBytimeGetParamsTimeDeltaYear),
		...
		Metrics:    khulnasoft.F([]spectrum.AnalyticsEventBytimeGetParamsMetric{spectrum.AnalyticsEventBytimeGetParamsMetricCount, spectrum.AnalyticsEventBytimeGetParamsMetricBytesIngress}),
