...
//
// API references:
//   - https://developers.khulnasoft.com/api/operations/ip-access-rules-for-a-user-list-ip-access-rules
//   - https://developers.khulnasoft.com/api/operations/ip-access-rules-for-a-zone-list-ip-access-rules
//   - https://developers.khulnasoft.com/api/operations/ip-access-rules-for-an-account-list-ip-access-rules
