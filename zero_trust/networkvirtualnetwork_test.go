...
func TestNetworkVirtualNetworkNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Networks.VirtualNetworks.New(context.TODO(), zero_trust.NetworkVirtualNetworkNewParams{
		...
		Name:      khulnasoft.F("us-east-1-vpc"),
		Comment:   khulnasoft.F("Staging VPC for data science"),
...
func TestNetworkVirtualNetworkListWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Networks.VirtualNetworks.List(context.TODO(), zero_trust.NetworkVirtualNetworkListParams{
		AccountID: khulnasoft.F("699d98642c564d2e855e9661899b7252"),
		ID:        khulnasoft.F("f70ff985-a4ef-4643-bbbc-4a0ed4fc8415"),
		IsDefault: khulnasoft.F(true),
...
func TestNetworkVirtualNetworkEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Networks.VirtualNetworks.Edit(
		...
		zero_trust.NetworkVirtualNetworkEditParams{
			AccountID:        khulnasoft.F("699d98642c564d2e855e9661899b7252"),
			Comment:          khulnasoft.F("Staging VPC for data science"),
			IsDefaultNetwork: khulnasoft.F(true),
			Name:             khulnasoft.F("us-east-1-vpc"),
		},
	)
	if err != nil {
