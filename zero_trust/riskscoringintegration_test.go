...
func TestRiskScoringIntegrationNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.RiskScoring.Integrations.New(context.TODO(), zero_trust.RiskScoringIntegrationNewParams{
		...
		IntegrationType: khulnasoft.F(zero_trust.RiskScoringIntegrationNewParamsIntegrationTypeOkta),
		TenantURL:       khulnasoft.F("https://example.com"),
		ReferenceID:     khulnasoft.F("reference_id"),
	})
	if err != nil {
