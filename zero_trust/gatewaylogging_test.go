...
func TestGatewayLoggingUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.ZeroTrust.Gateway.Logging.Update(context.TODO(), zero_trust.GatewayLoggingUpdateParams{
		...
		LoggingSetting: zero_trust.LoggingSettingParam{
			RedactPii: khulnasoft.F(true),
			SettingsByRuleType: khulnasoft.F(zero_trust.LoggingSettingSettingsByRuleTypeParam{
				DNS:  khulnasoft.F[any](map[string]interface{}{}),
				HTTP: khulnasoft.F[any](map[string]interface{}{}),
				L4:   khulnasoft.F[any](map[string]interface{}{}),
			}),
		},
	})
	if err != nil {
