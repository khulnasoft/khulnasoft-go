...
type CachePurgeParamsBody struct {
	...
	// [purge everything documentation page](https://developers.khulnasoft.com/cache/how-to/purge-cache/purge-everything/).
...
type CachePurgeParamsBodyCachePurgeFlexPurgeByTags struct {
	...
	// [purge by cache-tags documentation page](https://developers.khulnasoft.com/cache/how-to/purge-cache/purge-by-tags/#purge-cache-by-cache-tags-enterprise-only).
...
type CachePurgeParamsBodyCachePurgeFlexPurgeByHostnames struct {
	...
	// [purge by hostname documentation page](https://developers.khulnasoft.com/cache/how-to/purge-cache/purge-by-hostname/).
...
type CachePurgeParamsBodyCachePurgeFlexPurgeByPrefixes struct {
	...
	// [purge by prefix documentation page](https://developers.khulnasoft.com/cache/how-to/purge-cache/purge_by_prefix/).
...
type CachePurgeParamsBodyCachePurgeSingleFile struct {
	...
	// [purge by single-file documentation page](https://developers.khulnasoft.com/cache/how-to/purge-cache/purge-by-single-file/).
