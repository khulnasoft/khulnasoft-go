...
func TestHostnameNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Web3.Hostnames.New(context.TODO(), web3.HostnameNewParams{
		...
		Target:      khulnasoft.F(web3.HostnameNewParamsTargetEthereum),
		Description: khulnasoft.F("This is my IPFS gateway."),
		Dnslink:     khulnasoft.F("/ipns/onboarding.ipfs.khulnasoft.com"),
	})
	if err != nil {
