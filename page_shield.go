...
type PageShield struct {
	...
	UseKhulnasoftReportingEndpoint *bool `json:"use_khulnasoft_reporting_endpoint,omitempty"`
...
//
// API documentation: https://developers.khulnasoft.com/api/operations/page-shield-get-page-shield-settings
...
//
// API documentation: https://developers.khulnasoft.com/api/operations/page-shield-update-page-shield-settings
