...
func TestGetTelemetry(t *testing.T) {
	...
	assert.Equal(t, uint64(23), tlm.TotalPayloadsSent, "telmetry TotalPayloadsSent was wrong")
	...
	assert.Equal(t, uint64(3187), tlm.TotalBytesSent, "telmetry TotalBytesSent was wrong")
