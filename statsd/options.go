...
// https://docs.khulnasoft.com/developers/dogstatsd/high_throughput/#ensure-proper-packet-sizes.
...
//
// More on this here: https://docs.khulnasoft.com/developers/dogstatsd/high_throughput/#client-side-telemetry
...
//
// More on this here: https://docs.khulnasoft.com/developers/dogstatsd/?tab=kubernetes#origin-detection-over-udp
...
// This feature requires Khulnasoft Agent version >=6.35.0 && <7.0.0 or Agent versions >=7.35.0.
// When enabled, the client tries to discover its container ID and sends it to the Agent
// to enrich the metrics with container tags.
// If the container id is not found and the client is running in a private cgroup namespace, the client
// sends the base cgroup controller inode.
