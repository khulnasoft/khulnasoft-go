...
// Events support
// EventAlertType and EventAlertPriority became exported types after this issue was submitted: https://github.com/khulnasoft/khulnasoft-go/issues/41
...
// An Event is an object that can be posted to your KhulnaSoft event stream.
type Event struct {
