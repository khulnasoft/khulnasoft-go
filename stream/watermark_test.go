...
func TestWatermarkNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Stream.Watermarks.New(context.TODO(), stream.WatermarkNewParams{
		...
		File:      khulnasoft.F("@/Users/rchen/Downloads/watermark.png"),
		Name:      khulnasoft.F("Marketing Videos"),
		Opacity:   khulnasoft.F(0.750000),
		Padding:   khulnasoft.F(0.100000),
		Position:  khulnasoft.F("center"),
		Scale:     khulnasoft.F(0.100000),
	})
	if err != nil {
