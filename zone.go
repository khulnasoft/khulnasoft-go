...
// Zone describes a Khulnasoft zone.
type Zone struct {
	ID   string `json:"id"`
	Name string `json:"name"`
...
type PurgeCacheRequest struct {
	...
	// https://support.khulnasoft.com/hc/en-us/articles/206596608-How-to-Purge-Cache-Using-Cache-Tags-Enterprise-only-
...
//
// API reference: https://api.khulnasoft.com/#zone-create-a-zone
...
//
// API reference: https://api.khulnasoft.com/#zone-initiate-another-zone-activation-check
...
// to filter against.
//
// API reference: https://api.khulnasoft.com/#zone-list-zones
...
//
// API reference: https://api.khulnasoft.com/#zone-zone-details
...
// ZoneSetPaused pauses Khulnasoft service for the entire zone, sending all
...
//
// API reference: https://api.khulnasoft.com/#zone-edit-zone
...
// "CF_ENT".
//
// API reference: https://api.khulnasoft.com/#zone-subscription-create-zone-subscription
...
// "CF_ENT".
//
// API reference: https://api.khulnasoft.com/#zone-subscription-update-zone-subscription
...
//
// API reference: https://api.khulnasoft.com/#zone-edit-zone-properties
...
//
// API reference: https://api.khulnasoft.com/#zone-purge-all-files
...
//
// API reference: https://api.khulnasoft.com/#zone-purge-individual-files-by-url-and-cache-tags
...
//
// API reference: https://api.khulnasoft.com/#zone-delete-a-zone
...
//
// API reference: https://api.khulnasoft.com/#zone-plan-available-plans
...
//
// API reference: https://api.khulnasoft.com/#zone-rate-plan-list-available-plans
...
//
// API reference: https://api.khulnasoft.com/#zone-analytics-dashboard
...
//
// API reference: https://api.khulnasoft.com/#zone-analytics-analytics-by-co-locations
...
//
// API reference: https://api.khulnasoft.com/#zone-settings-get-all-zone-settings
...
//
// API reference: https://api.khulnasoft.com/#zone-settings-edit-zone-settings-info
...
//
// API reference: https://api.khulnasoft.com/#zone-settings-get-ssl-setting
...
//
// API reference: https://api.khulnasoft.com/#zone-settings-change-ssl-setting
...
//
// API reference: https://api.khulnasoft.com/#dns-records-for-a-zone-export-dns-records
...
//
// API reference: https://api.khulnasoft.com/#dnssec-dnssec-details
...
//
// API reference: https://api.khulnasoft.com/#dnssec-delete-dnssec-records
...
//
// API reference: https://api.khulnasoft.com/#dnssec-edit-dnssec-status
