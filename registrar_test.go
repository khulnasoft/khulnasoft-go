...
func TestRegistrarDomain(t *testing.T) {
	...
	mux.HandleFunc("/accounts/01a7362d577a6c3019a474fd6f485823/registrar/domains/khulnasoft.com", handler)

	actual, err := client.RegistrarDomain(context.Background(), "01a7362d577a6c3019a474fd6f485823", "khulnasoft.com")
...
func TestTransferRegistrarDomain(t *testing.T) {
	...
	mux.HandleFunc("/accounts/01a7362d577a6c3019a474fd6f485823/registrar/domains/khulnasoft.com/transfer", handler)

	actual, err := client.TransferRegistrarDomain(context.Background(), "01a7362d577a6c3019a474fd6f485823", "khulnasoft.com")
...
func TestCancelRegistrarDomainTransfer(t *testing.T) {
	...
	mux.HandleFunc("/accounts/01a7362d577a6c3019a474fd6f485823/registrar/domains/khulnasoft.com/cancel_transfer", handler)

	actual, err := client.CancelRegistrarDomainTransfer(context.Background(), "01a7362d577a6c3019a474fd6f485823", "khulnasoft.com")
...
func TestUpdateRegistrarDomain(t *testing.T) {
	...
	actual, err := client.UpdateRegistrarDomain(context.Background(), "01a7362d577a6c3019a474fd6f485823", "khulnasoft.com", RegistrarDomainConfiguration{
