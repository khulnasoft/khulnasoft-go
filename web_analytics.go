...
type WebAnalyticsSite struct {
	...
	// AutoInstall defines whether Khulnasoft will inject the JS snippet automatically for orange-clouded sites.
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-create-site
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-list-sites
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-get-site
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-update-site
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-delete-site
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-create-rule
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-list-rules
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-delete-rule
...
//
// API reference: https://api.khulnasoft.com/#web-analytics-update-rule
