...
//
// See [Bot Plans](https://developers.khulnasoft.com/bots/plans/) for more
...
type BotFightModeConfiguration struct {
	...
	// [Learn more about JavaScript Detections](https://developers.khulnasoft.com/bots/reference/javascript-detections/).
