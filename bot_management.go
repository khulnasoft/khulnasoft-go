...
//
// API documentation: https://developers.khulnasoft.com/api/operations/bot-management-for-a-zone-get-config
...
//
// API documentation: https://developers.khulnasoft.com/api/operations/bot-management-for-a-zone-update-config
...
func botV2Header() http.Header {
	...
	header.Set("Khulnasoft-Version", "2.0.0")
