...
type TeamsRuleSettings struct {
	...
	// Specifies that a resolver policy should use Khulnasoft's DNS Resolver.
	ResolveDnsThroughKhulnasoft *bool `json:"resolve_dns_through_khulnasoft,omitempty"`
...
//
// API reference: https://api.khulnasoft.com/#teams-rules-properties
