...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-applications-list-access-applications
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-applications-list-access-applications
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-applications-get-an-access-application
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-applications-get-an-access-application
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-applications-add-an-application
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-applications-add-a-bookmark-application
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-applications-update-a-bookmark-application
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-applications-update-a-bookmark-application
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-applications-delete-an-access-application
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-applications-delete-an-access-application
...
// access application.
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-applications-revoke-service-tokens
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-applications-revoke-service-tokens
