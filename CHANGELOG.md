...
- deps: bumps actions/setup-go from 4 to 5 ([#1460](https://github.com/khulnasoft/khulnasoft-go/issues/1460))
...
- deps: bumps github.com/hashicorp/go-retryablehttp from 0.7.4 to 0.7.5 ([#1438](https://github.com/khulnasoft/khulnasoft-go/issues/1438))
...
- workers: Add support for uploading scripts to a Workers for Platforms namespace. ([#1330](https://github.com/khulnasoft/khulnasoft-go/issues/1330))
...
- device_posture_rule: support active_threats, network_status, infected, and is_active for sentinelone_s2s posture rule ([#1339](https://github.com/khulnasoft/khulnasoft-go/issues/1339))
...
- logpush: `ValidateZoneLogpushOwnershipChallenge` is removed in favour of `ValidateLogpushOwnershipChallenge` with `ResourceContainer` method parameter ([#1326](https://github.com/khulnasoft/khulnasoft-go/issues/1326))
...
- images: adds support for v2 when uploading images directly ([#1322](https://github.com/khulnasoft/khulnasoft-go/issues/1322))
...
- deps: bumps actions/setup-go from 3 to 4 ([#1236](https://github.com/khulnasoft/khulnasoft-go/issues/1236))
...
- pages: removed the v1 logs endpoint for Pages deployments. Please switch to v2: https://developers.khulnasoft.com/api/operations/pages-deployment-get-deployment-logs ([#1135](https://github.com/khulnasoft/khulnasoft-go/issues/1135))
...
- email_routing_destination: Update API reference URLs ([#1038](https://github.com/khulnasoft/khulnasoft-go/issues/1038))
- email_routing_rules: Update API reference URLs ([#1038](https://github.com/khulnasoft/khulnasoft-go/issues/1038))
- email_routing_settings: Update API reference URLs ([#1038](https://github.com/khulnasoft/khulnasoft-go/issues/1038))
- tunnel_routes: Fix not removing route when it contains virtual network ([#1030](https://github.com/khulnasoft/khulnasoft-go/issues/1030))
- workers_test: Fix incorrect test from PR #1014 ([#1048](https://github.com/khulnasoft/khulnasoft-go/issues/1048))
- workers_test: Use application/json mime-type in headers ([#1049](https://github.com/khulnasoft/khulnasoft-go/issues/1049))

DEPENDENCIES:

- deps: bumps golang.org/x/tools/gopls from 0.9.3 to 0.9.4 ([#1044](https://github.com/khulnasoft/khulnasoft-go/issues/1044))
- deps: bumps github.com/golangci/golangci-lint from 1.47.3 to 1.48.0 ([#1020](https://github.com/khulnasoft/khulnasoft-go/issues/1020))
- deps: bumps github.com/urfave/cli/v2 from 2.11.1 to 2.11.2 ([#1042](https://github.com/khulnasoft/khulnasoft-go/issues/1042))
- deps: bumps golang.org/x/tools/gopls from 0.9.1 to 0.9.2 ([#1037](https://github.com/khulnasoft/khulnasoft-go/issues/1037))
- deps: bumps golang.org/x/tools/gopls from 0.9.2 to 0.9.3 ([#1039](https://github.com/khulnasoft/khulnasoft-go/issues/1039))

## 0.46.0 (3rd August, 2022)

NOTES:

- docs: add release notes ([#1001](https://github.com/khulnasoft/khulnasoft-go/issues/1001))

ENHANCEMENTS:

- filter: automatically paginate `List` results unless `Page` and `PerPage` are provided ([#1004](https://github.com/khulnasoft/khulnasoft-go/issues/1004))
- firewall_rule: automatically paginate `List` results unless `Page` and `PerPage` are provided ([#1004](https://github.com/khulnasoft/khulnasoft-go/issues/1004))
- rulesets: add support for `http_custom_errors` phase ([#998](https://github.com/khulnasoft/khulnasoft-go/issues/998))
- rulesets: add support for `serve_error` action ([#998](https://github.com/khulnasoft/khulnasoft-go/issues/998))

BUG FIXES:

- access_application: fix inability to set bool values to false ([#1006](https://github.com/khulnasoft/khulnasoft-go/issues/1006))
- rulesets: fix sni action parameter ([#1002](https://github.com/khulnasoft/khulnasoft-go/issues/1002))

DEPENDENCIES:

- provider: bumps github.com/golangci/golangci-lint from 1.47.1 to 1.47.2 ([#1005](https://github.com/khulnasoft/khulnasoft-go/issues/1005))
- provider: bumps github.com/golangci/golangci-lint from 1.47.2 to 1.47.3 ([#1008](https://github.com/khulnasoft/khulnasoft-go/issues/1008))
- provider: bumps github.com/urfave/cli/v2 from 2.11.0 to 2.11.1 ([#1003](https://github.com/khulnasoft/khulnasoft-go/issues/1003))
