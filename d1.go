...
//
// API reference: https://developers.khulnasoft.com/api/operations/khulnasoft-d1-list-databases
...
//
// API reference: https://developers.khulnasoft.com/api/operations/khulnasoft-d1-create-database
...
//
// API reference: https://developers.khulnasoft.com/api/operations/khulnasoft-d1-delete-database
...
//
// API reference: https://developers.khulnasoft.com/api/operations/khulnasoft-d1-get-database
...
//
// API reference: https://developers.khulnasoft.com/api/operations/khulnasoft-d1-query-database
