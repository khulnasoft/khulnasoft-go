...
func TestEdgeNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Logpush.Edge.New(context.TODO(), logpush.EdgeNewParams{
		...
		Fields: khulnasoft.F("ClientIP,ClientRequestHost,ClientRequestMethod,ClientRequestURI,EdgeEndTimestamp,EdgeResponseBytes,EdgeResponseStatus,EdgeStartTimestamp,RayID"),
		Filter: khulnasoft.F("{\"where\":{\"and\":[{\"key\":\"ClientCountry\",\"operator\":\"neq\",\"value\":\"ca\"}]}}"),
		Sample: khulnasoft.F(int64(1)),
	})
	if err != nil {
