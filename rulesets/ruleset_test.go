...
func TestRulesetNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Rulesets.New(context.TODO(), rulesets.RulesetNewParams{
		Kind:  khulnasoft.F(rulesets.KindManaged),
		Name:  khulnasoft.F("My ruleset"),
		Phase: khulnasoft.F(rulesets.PhaseDDoSL4),
		Rules: khulnasoft.F([]rulesets.RulesetNewParamsRuleUnion{rulesets.BlockRuleParam{
...
func TestRulesetUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Rulesets.Update(
		...
		rulesets.RulesetUpdateParams{
			Rules: khulnasoft.F([]rulesets.RulesetUpdateParamsRuleUnion{rulesets.BlockRuleParam{
				ID:     khulnasoft.F("3a03d665bac047339bb530ecb439a90d"),
				Action: khulnasoft.F(rulesets.BlockRuleActionBlock),
				ActionParameters: khulnasoft.F(rulesets.BlockRuleActionParametersParam{
					Response: khulnasoft.F(rulesets.BlockRuleActionParametersResponseParam{
