...
func TestRuleNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Rulesets.Rules.New(
		...
		rulesets.RuleNewParams{
			...
			Position: khulnasoft.F[rulesets.RuleNewParamsPositionUnion](rulesets.RuleNewParamsPositionBeforePosition{
				Before: khulnasoft.F("da5e8e506c8e7877fe06cdf4c41add54"),
			}),
		},
	)
	if err != nil {
...
func TestRuleEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Rulesets.Rules.Edit(
		...
		rulesets.RuleEditParams{
			AccountID: khulnasoft.F("account_id"),
			Position: khulnasoft.F[rulesets.RuleEditParamsPositionUnion](rulesets.RuleEditParamsPositionBeforePosition{
				Before: khulnasoft.F("da5e8e506c8e7877fe06cdf4c41add54"),
			}),
		},
	)
