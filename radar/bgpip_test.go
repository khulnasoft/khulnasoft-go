...
func TestBGPIPTimeseriesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.BGP.IPs.Timeseries(context.TODO(), radar.BGPIPTimeseriesParams{
		...
		Format:       khulnasoft.F(radar.BgpipTimeseriesParamsFormatJson),
		IncludeDelay: khulnasoft.F(true),
		IPVersion:    khulnasoft.F([]radar.BgpipTimeseriesParamsIPVersion{radar.BgpipTimeseriesParamsIPVersionIPv4, radar.BgpipTimeseriesParamsIPVersionIPv6}),
