...
func TestQualitySpeedHistogramWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Quality.Speed.Histogram(context.TODO(), radar.QualitySpeedHistogramParams{
		...
		BucketSize:  khulnasoft.F(int64(0)),
		Continent:   khulnasoft.F([]string{"string", "string", "string"}),
		DateEnd:     khulnasoft.F([]time.Time{time.Now(), time.Now(), time.Now()}),
		Format:      khulnasoft.F(radar.QualitySpeedHistogramParamsFormatJson),
		Location:    khulnasoft.F([]string{"string", "string", "string"}),
		MetricGroup: khulnasoft.F(radar.QualitySpeedHistogramParamsMetricGroupBandwidth),
...
func TestQualitySpeedSummaryWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Quality.Speed.Summary(context.TODO(), radar.QualitySpeedSummaryParams{
		...
		Continent: khulnasoft.F([]string{"string", "string", "string"}),
		DateEnd:   khulnasoft.F([]time.Time{time.Now(), time.Now(), time.Now()}),
		Format:    khulnasoft.F(radar.QualitySpeedSummaryParamsFormatJson),
		Location:  khulnasoft.F([]string{"string", "string", "string"}),
		Name:      khulnasoft.F([]string{"string", "string", "string"}),
	})
	if err != nil {
