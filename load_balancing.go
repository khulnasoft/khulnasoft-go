...
type LoadBalancer struct {
	...
	// the Khulnasoft PoP location for proxied requests or the location determined by
...
type LocationStrategy struct {
	...
	//
	// "pop": (default) Use the Khulnasoft PoP location.
	//
	// "resolver_ip": Use the DNS resolver GeoIP location.
	// If the GeoIP lookup is unsuccessful, use the Khulnasoft PoP location.
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-pools-create-pool
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-pools-list-pools
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-pools-pool-details
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-pools-delete-pool
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-pools-update-pool
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-monitors-create-monitor
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-monitors-list-monitors
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-monitors-monitor-details
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-monitors-delete-monitor
...
//
// API reference: https://api.khulnasoft.com/#load-balancer-monitors-update-monitor
...
//
// API reference: https://api.khulnasoft.com/#load-balancers-create-load-balancer
...
//
// API reference: https://api.khulnasoft.com/#load-balancers-list-load-balancers
...
//
// API reference: https://api.khulnasoft.com/#load-balancers-load-balancer-details
...
//
// API reference: https://api.khulnasoft.com/#load-balancers-delete-load-balancer
...
//
// API reference: https://api.khulnasoft.com/#load-balancers-update-load-balancer
...
// pool.
//
// API reference: https://api.khulnasoft.com/#load-balancer-pools-pool-health-details
