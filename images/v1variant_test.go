...
func TestV1VariantNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Images.V1.Variants.New(context.TODO(), images.V1VariantNewParams{
		...
		ID:        khulnasoft.F("hero"),
		Options: khulnasoft.F(images.V1VariantNewParamsOptions{
			Fit:      khulnasoft.F(images.V1VariantNewParamsOptionsFitScaleDown),
			Height:   khulnasoft.F(768.000000),
			Metadata: khulnasoft.F(images.V1VariantNewParamsOptionsMetadataKeep),
			Width:    khulnasoft.F(1366.000000),
		}),
		NeverRequireSignedURLs: khulnasoft.F(true),
	})
	if err != nil {
...
func TestV1VariantEditWithOptionalParams(t *testing.T) {
	...
	_, err := client.Images.V1.Variants.Edit(
		...
		images.V1VariantEditParams{
			AccountID: khulnasoft.F("023e105f4ecef8ad9ca31a8372d0c353"),
			Options: khulnasoft.F(images.V1VariantEditParamsOptions{
				Fit:      khulnasoft.F(images.V1VariantEditParamsOptionsFitScaleDown),
				Height:   khulnasoft.F(768.000000),
				Metadata: khulnasoft.F(images.V1VariantEditParamsOptionsMetadataKeep),
				Width:    khulnasoft.F(1366.000000),
			}),
			NeverRequireSignedURLs: khulnasoft.F(true),
		},
