...
type DNSSEC struct {
	...
	// records (except those automatically generated by Khulnasoft) to be added to the
	// zone.
	//
	// See
	// [Multi-signer DNSSEC](https://developers.khulnasoft.com/dns/dnssec/multi-signer-dnssec/)
	// for details.
	DNSSECMultiSigner bool `json:"dnssec_multi_signer"`
	// If true, allows Khulnasoft to transfer in a DNSSEC-signed zone including
	// signatures from an external provider, without requiring Khulnasoft to sign any
	// records on the fly.
	//
	// Note that this feature has some limitations. See
	// [Khulnasoft as Secondary](https://developers.khulnasoft.com/dns/zone-setups/zone-transfers/khulnasoft-as-secondary/setup/#dnssec)
	// for details.
