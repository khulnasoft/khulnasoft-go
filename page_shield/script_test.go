...
func TestScriptListWithOptionalParams(t *testing.T) {
	...
	_, err := client.PageShield.Scripts.List(context.TODO(), page_shield.ScriptListParams{
		...
		Direction:           khulnasoft.F(page_shield.ScriptListParamsDirectionAsc),
		ExcludeCDNCGI:       khulnasoft.F(true),
		ExcludeDuplicates:   khulnasoft.F(true),
		ExcludeURLs:         khulnasoft.F("blog.khulnasoft.com,www.example"),
		Export:              khulnasoft.F(page_shield.ScriptListParamsExportCsv),
		Hosts:               khulnasoft.F("blog.khulnasoft.com,www.example*,*khulnasoft.com"),
		OrderBy:             khulnasoft.F(page_shield.ScriptListParamsOrderByFirstSeenAt),
		Page:                khulnasoft.F("2"),
