...
func TestBucketNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.R2.Buckets.New(context.TODO(), r2.BucketNewParams{
		...
		Name:         khulnasoft.F("example-bucket"),
		LocationHint: khulnasoft.F(r2.BucketNewParamsLocationHintApac),
		StorageClass: khulnasoft.F(r2.BucketNewParamsStorageClassStandard),
	})
	if err != nil {
...
func TestBucketListWithOptionalParams(t *testing.T) {
	...
	_, err := client.R2.Buckets.List(context.TODO(), r2.BucketListParams{
		AccountID:    khulnasoft.F("023e105f4ecef8ad9ca31a8372d0c353"),
		Cursor:       khulnasoft.F("cursor"),
		Direction:    khulnasoft.F(r2.BucketListParamsDirectionAsc),
		NameContains: khulnasoft.F("my-bucket"),
		Order:        khulnasoft.F(r2.BucketListParamsOrderName),
		PerPage:      khulnasoft.F(1.000000),
		StartAfter:   khulnasoft.F("my-bucket"),
	})
	if err != nil {
		var apierr *khulnasoft.Error
		if errors.As(err, &apierr) {
