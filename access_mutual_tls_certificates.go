...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-list-mtls-certificates
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-list-mtls-certificates
...
// certificate.
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-get-an-mtls-certificate
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-get-an-mtls-certificate
...
// certificate.
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-add-an-mtls-certificate
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-add-an-mtls-certificate
...
// certificate.
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-update-an-mtls-certificate
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-update-an-mtls-certificate
...
// TLS certificate.
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-delete-an-mtls-certificate
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-delete-an-mtls-certificate
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-update-an-mtls-certificate-settings
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-list-mtls-certificates-hostname-settings
...
//
// Account API Reference: https://developers.khulnasoft.com/api/operations/access-mtls-authentication-update-an-mtls-certificate-settings
// Zone API Reference: https://developers.khulnasoft.com/api/operations/zone-level-access-mtls-authentication-update-an-mtls-certificate-settings
