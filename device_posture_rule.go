...
//
// API reference: https://api.khulnasoft.com/#device-posture-integrations-create-device-posture-integration
...
//
// API reference: https://api.khulnasoft.com/#device-posture-integrations-update-device-posture-integration
...
//
// API reference: https://api.khulnasoft.com/#device-posture-integrations-device-posture-integration-details
...
//
// API reference: https://api.khulnasoft.com/#device-posture-integrations-list-device-posture-integrations
...
//
// API reference: https://api.khulnasoft.com/#device-posture-integrations-delete-device-posture-integration
...
//
// API reference: https://api.khulnasoft.com/#device-posture-rules-list-device-posture-rules
...
//
// API reference: https://api.khulnasoft.com/#device-posture-rules-device-posture-rules-details
...
//
// API reference: https://api.khulnasoft.com/#device-posture-rules-create-device-posture-rule
...
//
// API reference: https://api.khulnasoft.com/#device-posture-rules-update-device-posture-rule
...
//
// API reference: https://api.khulnasoft.com/#device-posture-rules-delete-device-posture-rule
