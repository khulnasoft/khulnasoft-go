...
//
// API reference: https://developers.khulnasoft.com/api/operations/zero-trust-accounts-get-connectivity-settings
...
//
// API reference: https://developers.khulnasoft.com/api/operations/zero-trust-accounts-patch-connectivity-settings
