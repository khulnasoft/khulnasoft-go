...
type TeamsAccount struct {
	...
	ID              string `json:"id"`                          // khulnasoft account ID
	TenantAccountID string `json:"tenant_account_id,omitempty"` // khulnasoft Tenant account ID, if a tenant account
	TenantID        string `json:"tenant_id,omitempty"`         // khulnasoft Tenant ID, if a tenant account id
}
...
//
// API reference: https://developers.khulnasoft.com/api/resources/zero_trust/subresources/connectivity_settings/methods/get/
...
//
// API reference: https://developers.khulnasoft.com/api/resources/zero_trust/subresources/connectivity_settings/methods/edit/
