...
func TestIndicatorFeedNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Intel.IndicatorFeeds.New(context.TODO(), intel.IndicatorFeedNewParams{
		...
		Description: khulnasoft.F("example feed description"),
		Name:        khulnasoft.F("example_feed_1"),
	})
	if err != nil {
...
func TestIndicatorFeedUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Intel.IndicatorFeeds.Update(
		...
		intel.IndicatorFeedUpdateParams{
			AccountID:      khulnasoft.F("023e105f4ecef8ad9ca31a8372d0c353"),
			Description:    khulnasoft.F("This is an example description"),
			IsAttributable: khulnasoft.F(true),
			IsDownloadable: khulnasoft.F(true),
			IsPublic:       khulnasoft.F(true),
			Name:           khulnasoft.F("indicator_list"),
		},
	)
	if err != nil {
		var apierr *khulnasoft.Error
