...
type CreateAccessPolicyParams struct {
	...
	// Read more here https://developers.khulnasoft.com/khulnasoft-one/policies/access/#order-of-execution
	Precedence int    `json:"precedence"`
	Decision   string `json:"decision"`
	Name       string `json:"name"`
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-policies-list-access-policies
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-policies-list-access-policies
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-policies-get-an-access-policy
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-policies-get-an-access-policy
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-policies-create-an-access-policy
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-policies-create-an-access-policy
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-policies-update-an-access-policy
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-policies-update-an-access-policy
...
//
// Account API reference: https://developers.khulnasoft.com/api/operations/access-policies-delete-an-access-policy
// Zone API reference: https://developers.khulnasoft.com/api/operations/zone-level-access-policies-delete-an-access-policy
